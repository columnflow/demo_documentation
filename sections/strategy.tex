...
In order to find Higgs boson candidates we will first need to reconstruct the four leptons in the final state. We will do this by writing a \CCSPStlye{Selector} (Section~\ref{sec:selector}).
